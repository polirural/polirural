...
The Open Access Infrastructure for Research in Europe ([**OpenAIRE**](https://www.openaire.eu/)) provides additional information and support on linking publications to underlying research data. [**Zenodo**](https://zenodo.org/), an OpenAIRE and CERN collaboration, is a repository that llows researchers to deposit both publications and data, while providing tools to link them.
